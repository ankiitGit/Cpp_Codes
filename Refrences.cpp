...
/*
REFRENCES: it is adress only but we call it refrence (slightly different though) as same as we call water as JAL in pooja 
...
4. we have just given refrence(hidden pointer) of x as y 
