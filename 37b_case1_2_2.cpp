...
// case 1.2.2 ----> constructor in derived class ( base class construcor to hai hi )
// Defualt in derived and permetrised in base class 
...
class derived : public base{
   ...
   public:
    derived(int y):base(y){  //isko us syntax m ese bhi likh skte the " derived(int y):base(){} ".....pr defualt wale ke lie vo syantax use krna jaruri nhi hai .......
        b=1000;                        
